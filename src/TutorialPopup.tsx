...
import tutorialArrow from './util/tutorial-arrow.png'
...
const TutorialPopup: FunctionComponent = () => {
  ...
  return (
    <>
    {
      ...
      <div css={boxStyle(currentMessage.boxTop,currentMessage.boxLeft,currentMessage.boxWidth)}>
    ...
    }
    {
      ...
      <img alt={t('Tutorial Indicator')} src={tutorialArrow} draggable="false" css={arrowStyle(currentMessage.arrowAngle,currentMessage.arrowTop,currentMessage.arrowLeft)}/>
    }
    </>
  )
}
...
const tutorialDescription = {
  [0]: {
    [0]: {
      ...
      text: (t: TFunction) => t('Vous allez développer un Empire dystopique en 4 tours face à deux factions concurentes.'),
      boxTop: 50,
      boxLeft: 50,
      boxWidth:60,
      arrow:false
