...
const TutorialPopup: FunctionComponent = () => {
  ...
  return (
    <>
    {
      ...
      <div css={[boxStyle(currentMessage.boxTop,currentMessage.boxLeft,currentMessage.boxWidth), theme.color === LightTheme ? boxLightStyle:boxDarkStyle]}>
    ...
    }
    {
      ...
      <img alt={t('Tutorial Indicator')} src={theme.color === LightTheme ? tutorialArrowLight:tutorialArrowDark} draggable="false" css={arrowStyle(currentMessage.arrowAngle,currentMessage.arrowTop,currentMessage.arrowLeft)}/>
    }
    </>
  )
}
...
const tutorialDescription = {
  0 : {
    0: {
      ...
      text: (t: TFunction) => t('Vous allez développer un Empire dystopique en 4 tours face à deux factions concurrentes.'),
      boxTop: 50,
      boxLeft: 50,
      boxWidth:65,
      arrow:false
    ...
    1: {
      ...
      text: (t: TFunction) => t('Le jeu commence par une phase de Draft lors de laquelle vous choisissez 1 carte parmi 7, avant de passer les cartes restantes à votre voisin de gauche. '),
      boxTop: 48,
      boxLeft: 50,
      boxWidth:70,
      arrow:true,
    ...
    2: {
      title: (t: TFunction) => t('Stratégie globale'),
