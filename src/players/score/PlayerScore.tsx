...
const PlayerScore: FunctionComponent<Props> = ({player,position,displayScore,setDisplayScore}) => {
  ...
  return (
    <div css={[style(position), displayScore?displayPlayerScore:hidePlayerScore]}>
      <button css={[arrowStyle, displayScore?arrowStandardStyle:arrowReverseStyle]} onClick={() => setDisplayScore(!displayScore)} title={displayScore?t('Réduire les Scores'):t('Afficher les Scores')}/>
